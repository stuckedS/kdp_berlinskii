...
<body>
    <div class="topnav">
        ...
        <a class="active" href="adm_pilots.php">Редактировать Пилоты</a>
            ...
            <section>
                ...
                <form>
                    <div class="form-group">
                        ...
                        <a class ='btn btn-primary' type='submit' href=/adm_edit.php?table=pilots&Idd='<?php ECHO $_GET["ID"]?>'>Поиск</a>
                    </div>
                </form>
                <?php
